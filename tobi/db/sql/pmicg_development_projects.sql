...
CREATE TABLE `projects` (
  ...
  `direct_cost_amount` float DEFAULT NULL,
  `general_cost_amount` float DEFAULT NULL,
  `utility_amount` float DEFAULT NULL,
  `advance_payment_percent` float DEFAULT NULL,
  `coaching_granted_percent` float DEFAULT NULL,
...
INSERT INTO `projects` VALUES (1,NULL,'Bagua',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2013-12-17 06:27:56','2013-12-17 06:27:56',0,NULL,NULL);
