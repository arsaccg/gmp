class Management::CostCentersController < ApplicationController
  ...
  def cost_center_parameters
    params.require(:costcenter).permit(:name, :total_amount, :direct_cost_amount, :general_cost_amount, :utility_amount, :advance_payment_percent, :coaching_granted_percent, :igv)
  end
end
