  ...
  read_loop: LOOP
    ...
    BLOCKGE: BEGIN
      ...
      DECLARE meta CURSOR FOR 
        ...
        AND DATE_FORMAT( ge.created_at,  '%Y-%m-%d' ) BETWEEN '2015-08-01' AND '2015-08-31'
    ...
    BLOCKDEM: BEGIN
      ...
      DECLARE meta CURSOR FOR 
        ...
        AND DATE_FORMAT( dem.delivered_date,  '%Y-%m-%d' ) BETWEEN '2015-08-01' AND '2015-08-31'
    ...
    BLOCKPAY: BEGIN
      ...
      DECLARE payroll CURSOR FOR 
        ...
        AND DATE_FORMAT( p.last_worked_day,  '%Y-%m-%d' ) BETWEEN '2015-08-01' AND '2015-08-31'
