...
IF p_responsibles = '' THEN
  ...
  INNER JOIN `cost_center_timelines` cct ON cct.`cost_center_id` = ? AND cct.`date` = si.`issue_date`
  ...
  CASE @users
    WHEN 0 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
    WHEN 1 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
    WHEN 2 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_user_id, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
    WHEN 3 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
    WHEN 4 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
    WHEN 5 THEN
      EXECUTE stmt USING @p_cost_center, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_user_id, @p_company_id, @p_cost_center, @p_from_date, @p_to_date;
  END CASE;
