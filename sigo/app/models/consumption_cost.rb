...
class ConsumptionCost < ActiveRecord::Base
  ...
  def self.create_tables_new_costcenter(cost_center_id,start_date,end_date)
    ...
    create_tables_actual_consumption_cost_actual = connection.execute(
      "CREATE TABLE actual_consumption_cost_actual_" + cost_center_id.to_s + "
      (
    ...
    create_tables_actual_values = connection.execute(
      "CREATE TABLE projection_macro_" + cost_center_id.to_s + "
      (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `cd_mano_obra` varchar(20) NOT NULL DEFAULT '0',
        `cd_material` varchar(500) NOT NULL DEFAULT '0',
        `cd_equipo` varchar(40) NOT NULL DEFAULT '0',
        `cd_subcontrato` varchar(255) NOT NULL DEFAULT '0',
        `cd_servicio` char(20) DEFAULT NULL,
        `gg_mano_obra` varchar(20) NOT NULL DEFAULT '0',
        `gg_material` varchar(500) NOT NULL DEFAULT '0',
        `gg_equipo` varchar(40) NOT NULL DEFAULT '0',
        `gg_subcontrato` varchar(255) NOT NULL DEFAULT '0',
        `gg_servicio` char(20) DEFAULT NULL,
        `sg_mano_obra` varchar(20) NOT NULL DEFAULT '0',
        `sg_material` varchar(500) NOT NULL DEFAULT '0',
        `sg_equipo` varchar(40) NOT NULL DEFAULT '0',
        `sg_subcontrato` varchar(255) NOT NULL DEFAULT '0',
        `sg_servicio` char(20) DEFAULT NULL,
        `insertion_date` date DEFAULT NULL,  
        PRIMARY KEY (`id`)
    ...
    while (start_date <= end_date) do
      ...
      create_tables_actual_values = connection.execute(
        "CREATE TABLE acc_actual_values_" + cost_center_id.to_s + "_"+start_date.month.to_s.rjust(2,'0')+start_date.year.to_s.rjust(4,'0')+"
        (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          `article_code` varchar(20) NOT NULL,
          `article_name` varchar(500) NOT NULL,
      ...
      create_tables_actual_values = connection.execute(
        "CREATE TABLE projection_micro_" + cost_center_id.to_s + "_"+start_date.month.to_s.rjust(2,'0')+start_date.year.to_s.rjust(4,'0')+"
        (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          `article_code` varchar(20) NOT NULL,
          `article_name` varchar(500) NOT NULL,
      ...
      create_tables_actual_values = connection.execute(
        "CREATE TABLE acc_projection_micro_" + cost_center_id.to_s + "_"+start_date.month.to_s.rjust(2,'0')+start_date.year.to_s.rjust(4,'0')+"
        (
          `id` int(11) NOT NULL AUTO_INCREMENT,
          `article_code` varchar(20) NOT NULL,
          `article_name` varchar(500) NOT NULL,
