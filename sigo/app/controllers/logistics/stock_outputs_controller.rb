  ...
  def show_stock_outputs
    ...
    outputs.each do |output|
      array << [
        ...
        output[4],
        output[5],
        "<a style='margin-right: 5px;' class='btn btn-view btn-xs' data-original-title='Ver Detalle' data-placement='top' onclick=javascript:load_url_ajax('/logistics/stock_outputs/" + output[0].to_s + "','content',null,null,'GET') rel='tooltip'><i class='fa fa-eye'></i></a>" + "<a style='margin-right: 5px;' class='btn btn-warning btn-xs' data-original-title='Editar' data-placement='top' onclick=javascript:load_url_ajax('/logistics/stock_outputs/" + output[0].to_s + "/edit','content',null,null,'GET') rel='tooltip'><i class='fa fa-edit'></i></a>"+ "<a style='margin-right: 5px;' class='btn btn-pdf btn-xs' data-original-title='Ver PDF' data-placement='top' href='/logistics/stock_outputs/" + output[0].to_s + "/report_pdf.pdf' rel='tooltip' target='_blank'><i class='fa fa-file'></i></a>" + "<a class='btn btn-danger btn-xs' onclick=javascript:delete_to_url('/logistics/stock_outputs/" + output[0].to_s + "','content','/logistics/stock_outputs') data-placement='left' data-popout='true' data-singleton='true' data-title='Esta seguro de eliminar el item?' data-toggle='confirmation' data-original-title='' title='' style='margin-right: 5px;' data-original-title='Eliminar'  data-placement='top' ><i class='fa fa-trash-o'></i></a>"
      ]
    end
